  ...
  return (
    ...
    >
      <div className={styles.content}>
        <Title level={5}>
          "Atomning bo‘shlig‘i" (Rezerford tajribasi mantig'i)
        </Title>
        <Paragraph>
        ...
        <ul>
          ...
          <li>
            <Paragraph>
              ...
              barcha moddalar soniyalar ichida sochilib ketgan bo'lar edi.
            </Paragraph>
          </li>
        </ul>
        ...
        <ol>
          <li>
            <Paragraph>
              Masshtabni tasavvur qiling: Atom — deyarli bo'shliq.
            </Paragraph>
          </li>
          <li>
            <Paragraph>
              Kuchlarni solishtiring: Elektr kuchi itarsa, yadro kuchi tortadi.
            </Paragraph>
          </li>
        </ol>
      </div>
